...
import (
	"github.com/willie68/go-arch-lint/internal/pkg/deepscan/test/project/internal/operations"
	"github.com/willie68/go-arch-lint/internal/pkg/deepscan/test/project/internal/repository"
)
